...
class Login_Otp : AppCompatActivity() {
    ...
    private fun init() {
        ...
        progressBar = findViewById(com.example.firebase_project.R.id.otpProgressBar)
        verifyBtn = findViewById(com.example.firebase_project.R.id.verifyOTPBtn)
        resendTV = findViewById(com.example.firebase_project.R.id.resendTextView)
        inputOTP1 = findViewById(com.example.firebase_project.R.id.otpEditText1)
        inputOTP2 = findViewById(com.example.firebase_project.R.id.otpEditText2)
        inputOTP3 = findViewById(com.example.firebase_project.R.id.otpEditText3)
        inputOTP4 = findViewById(com.example.firebase_project.R.id.otpEditText4)
        inputOTP5 = findViewById(com.example.firebase_project.R.id.otpEditText5)
        inputOTP6 = findViewById(com.example.firebase_project.R.id.otpEditText6)
